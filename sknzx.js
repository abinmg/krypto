function getParameterByName(name) {
    ...
    var ConfiguracionCanales = {
      ...
      "USASPANISH": {
                ...
                k1: "a42669eafed7349499aab7df588b3ccf",
                k2: "0fbff143ebd097060a377e4ade033288"
            },
            "NBC_SPORTS": {
      ...
      "SPORTS1": {
	    ...
	    "BEIN3": {
                ...
                k1: "042a21bf236ca729b1e343ed6e0a6337",
                k2: "20c884ef8ed26b2762f8b1a78f2d1910"
            },
		"BBC": {
                url: "https://nlziet-live.akamaized.net/L22/6e958e41/3e8eb32a.isml/.mpd",
                k1: "859e0fc9638e4f7f848412736bcc8bb9",
                k2: "ff4fcc6c04f31a1eaced59d91940c9a7"
            },
            "PREMIER_LEAGUE_TV": {
             ...
             "SPOTV": {
                ...
                k1: "ec7ee27d83764e4b845c48cca31c8eef",
                k2: "9c0e4191203fccb0fde34ee29999129e"
            },
             "SPOTV2": {
                url: "https://qp-pldt-live-grp-13-prod.akamaized.net/out/u/dr_spotv2hd.mpd",
                k1: "7eea72d6075245a99ee3255603d58853",
                k2: "6848ef60575579bf4d415db1032153ed"
            },
            "SSC1": {
            ...
            "Astro_UHD": {
                url: "https://linearjitp-playback.astro.com.my/dash-wv/linear/1600/default_ott.mpd",
                k1: "8ac8b2f7af05ad829805345a517bc110",
                k2: "ee1ae1cd086fa9bfc0505e6d5e9e27e9"
            },

              "Astro_EPL1": {
                url: "https://linearjitp-playback.astro.com.my/dash-wv/linear/1600/default_ott.mpd",
                k1: "4f15413f7e4767b50c48e19b7f9a2fcc",
                k2: "f749ab71f227999bfb098f73359aac10"
            },

             "Astro_EPL2": {
                url: "https://linearjitp-playback.astro.com.my/dash-wv/linear/2104/default_ott.mpd",
                k1: "c1dc92f0789f112503c0db3bde2f1210",
                k2: "ddfa6e8d549b4d5177a9cade7f9a0b23"
            },
	      "Astro_EPL3": {
                url: "https://linearjitp-playback.astro.com.my/dash-wv/linear/5108/default_ott.mpd",
                k1: "1ece3ecb41699e855c6dc9a283908210",
                k2: "ba08be767e1a5e89777e68a6998a8c19"
            },
            "Astro_Football": {
            ...
            "Astro_Grandstand": {
                url: "https://linearjitp-playback.astro.com.my/dash-wv/linear/2701/default_ott.mpd",
                k1: "5be66a6f88efee3d6e30f72a9c58e310",
                k2: "168f3fadfc730ba3dfc932f7c430e27d"
            },
            "Astro_Sports_3": {
    ...
    if (config) {
        ...
        jwplayer("container").setup({
            playlist: [{
                image: "https://i.postimg.cc/2SvNpkFK/New-Project-81-38-FC63-E.png",
                title: "",
                description: "",
                sources: sources
            }],
            logo: {
                file: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQGbgHbZ_TtUyVHjqNTfmQD05FkyoFxZyx3g&s",
                link: "https://www.whatsapp.com/channel/0029Va6V441BqbrA2NZpkH2z",
                hide: "false",
        ...
        jwplayer("container").on("play", function (e) {
            jwplayer("container").setCurrentAudioTrack(1);
        });
    }
